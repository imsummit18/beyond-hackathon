...
const controlStyles = {
  base: 'border rounded-[9px] bg-white !min-h-[50px] border-primary-ultralight pl-2 hover:cursor-pointer min-h-[40px] flex items-start text-sm pr-[10px]',
...
const valueContainerStyles = 'p-1 gap-1 capitalize';
...
const optionStyles = {
  base: 'hover:cursor-pointer px-3 pl-5 py-2 rounded hover:bg-secondary hover:text-white transition-colors first-letter:capitalize',
